  ...
  return (
    <div>
         <div className="flex justify-center text-center">
              ...
              <h1 className="text-[#5D9943] font-bold text-center">Subscription</h1>
            </div>
        
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 px-24  gap-y-12 gap-x-0 my-14">
            {/* Standard */}
        <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
          ...
          <button type="button" className="text-white bg-gradient-to-r from-[#43995a] to-[#03d980] hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-200 dark:focus:ring-blue-900 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Choose plan</button>
        </div>
        {/* ------------- */}
        <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
          <h5 className="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400">Individual Plan</h5>
          <div className="flex items-baseline text-gray-900 dark:text-white">
            <span className="text-3xl font-semibold">Rs</span>
